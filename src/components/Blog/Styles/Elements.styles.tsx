	...
	return (
		<style global jsx>
			{`
				...
				a {
					@apply dark:text-white no-underline rounded transition duration-300 ease-in-out focus:outline-none focus:ring-4 focus:ring-teal-500 focus:ring-offset-2;
