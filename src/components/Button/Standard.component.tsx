...
const ButtonStyles =
	'flex justify-center items-center h-12 px-8 py-4 bg-gray-50 hover:(bg-gray-100 bg-opacity-50 text-teal-400) dark:(bg-gray-900 hover:bg-gray-800) text-base font-bold text-teal-300 rounded-lg default-transition default-focus';
